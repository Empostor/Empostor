...
namespace Empostor.Server
{
    internal static class Program
    {
        private static int Main(string[] args)
        {
            ...
            {
                Log.Fatal(ex, "Empostor terminated unexpectedly");
                return 1;
            }
            finally
            {
        ...
        private static IConfiguration CreateConfiguration(string[] args) =>
            new ConfigurationBuilder()
                ...
                .AddEnvironmentVariables(prefix: "EMPOSTOR_")
                .AddCommandLine(args)
                .Build();
...
#if DEBUG
                .UseEnvironment(Environment.GetEnvironmentVariable("EMPOSTOR_ENV") ?? "Development")
#else
