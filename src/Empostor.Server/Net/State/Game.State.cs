...
namespace Empostor.Server.Net.State
{
    internal partial class Game
    {
        ...
        private async ValueTask CheckLimboPlayers()
        {
            ...
            {
                // Pull the player out of limbo via HandleJoinGameNew (not
                // HandleJoinGameNext, which re-sets WaitingForHost and would
                // leave the player stuck on the wait-for-host screen).
