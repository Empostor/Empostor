    ...
    private const string DefaultEn = """
{
  ...
  "welcome.last_connect": "Last seen: {0}",
  "welcome.first_time": "First time here, welcome!",
    ...
    private const string DefaultZhCn = """
{
  ...
  "welcome.last_connect": "上次在线：{0}",
  "welcome.first_time": "首次光临，欢迎！",
    ...
    private const string DefaultZhTw = """
{
  ...
  "welcome.last_connect": "上次上線：{0}",
  "welcome.first_time": "首次光臨，歡迎！",
    ...
    private const string DefaultKo = """
{
  ...
  "welcome.last_connect": "마지막 접속: {0}",
  "welcome.first_time": "처음 방문이세요, 환영합니다!",
    ...
    private const string DefaultRu = """
{
  ...
  "welcome.last_connect": "Последний вход: {0}",
  "welcome.first_time": "Первый раз здесь, добро пожаловать!",
    ...
    private const string DefaultDe = """
{
  ...
  "welcome.last_connect": "Zuletzt online: {0}",
  "welcome.first_time": "Zum ersten Mal hier, willkommen!",
    ...
    private const string DefaultFr = """
{
  ...
  "welcome.last_connect": "Dernière visite : {0}",
  "welcome.first_time": "Première visite, bienvenue !",
    ...
    private const string DefaultJa = """
{
  ...
  "welcome.last_connect": "最終接続: {0}",
  "welcome.first_time": "初めてのご来訪、ようこそ！",
    ...
    private const string DefaultPt = """
{
  ...
  "welcome.last_connect": "Última visita: {0}",
  "welcome.first_time": "Primeira vez aqui, bem-vindo!",
