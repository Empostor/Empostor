...
namespace Empostor.Api.Net.Manager
{
    ...
    public interface ICompatibilityManager
    {
        ...
        ///
        /// WARNING: this method does not magically make changes to Empostor to properly support these versions. If
        /// Empostor cannot support the game versions you're trying to add or that the game versions you're making
