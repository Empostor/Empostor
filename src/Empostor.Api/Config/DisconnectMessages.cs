namespace Empostor.Api.Config
{
    public static class DisconnectMessages
    {
        public const string Error = "There was an internal server error. " +
                                    ...
                                    "Please report the issue on the Empostor GitHub if it keeps happening.";
        ...
        public const string VersionServerTooOld = "Your client is too new, please update your Empostor server to play.";

        public const string VersionUnsupported = "Your client version is unsupported, please update your Game and/or Empostor server.";

        private const string UpgradingDocsLink = "https://github.com/Empostor/Empostor/blob/master/docs/Upgrading.md";

        public const string UdpMatchmakingUnsupported = $"""
                                                        Sorry, UDP Matchmaking is no longer supported.
                                                        See <link={UpgradingDocsLink}#empostor-190>Empostor documentation</link> on how to migrate to HTTP Matchmaking
                                                        """;

        public const string HostAuthorityUnsupported = "Your client is requesting host authority, which is not enabled on this Empostor server.";
    }
}
