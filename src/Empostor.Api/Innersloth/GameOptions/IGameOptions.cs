...
namespace Empostor.Api.Innersloth.GameOptions;
...
public interface IGameOptions
{
    ...
    public static void EnsureVersionIsModular<TCaller>(byte version)
    {
        ...
        {
            throw new EmpostorException($"{typeof(TCaller).Name} didn't exist before version 7, did you mean {nameof(LegacyGameOptionsData)}?");
        }
    }
    ...
    {
        throw new EmpostorException($"Unknown {typeof(TCaller).Name} version {version}");
    }
}
